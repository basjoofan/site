...
如果您想注销账号，您需要在应用中通过如下路径【设置→注销账户】，再根据相关提示进行操作我们仅在为提供服务之目的所必需的期间内保留你的付款记录信息，在收到您的微信或支付宝账号注销的通知后，我们将定期对你的个人信息进行删除或匿名化处理。
...
在使用产品和服务时，我们会获取你设备的部分权限。我们主要会获取的权限以及对应的用途如下： 

| 序号 | 权限名称 | 获取方式 | 获取权限目的 |
| :---: | :---: | :---: | :---: |
| 1 | 拥有完全的网络访问权限 | 静默获取 | 允许应用创建网络套接字和使用自定义网络协议 | 

## 五、联系我们
随着产品的更新迭代，产品可能会不时增加、调整、删除相关功能。我们会在产品收集、处理用户信息的策略发生重大变更时，更新此隐私说明，为用户了解我们的信息处理策略提供最大便利。如您在在阅读过程中，对本政策有任何疑问，可联系我们的负责人进行咨询。

公司名称：大连芭蕉扇科技有限公司  
公司地址：辽宁省大连市高新园区听涛街19号  
联系电话：15000505295  
联系邮箱：lamb@basjoofan.com
